...
/*============================================================================
* Selects the Channel BW Mode
*===========================================================================*/
#define RTV_ISDBT_6MHZ_BW_ENABLE
//#define RTV_ISDBT_7MHZ_BW_ENABLE
//#define RTV_ISDBT_8MHZ_BW_ENABLE
/*============================================================================
...
*=============================================================================
* MTV318A(QFN) : #define RTV_SRC_CLK_FREQ_KHz  26000   
				 #define RTV_SRC_CLK_FREQ_KHz  32000   
				 #define RTV_SRC_CLK_FREQ_KHz  36000   
* MTV222(WLCSP) : #define RTV_SRC_CLK_FREQ_KHz  19200  //must be defined
*===========================================================================*/
//#define RTV_SRC_CLK_FREQ_KHz			36000
//#define RTV_SRC_CLK_FREQ_KHz			32000
...
extern U8 g_bRtvPage;
	...
	* Defines the register I/O macros.
	*================================================================*/
	unsigned char mtv_spi_read(U8 page, U8 reg);
	void mtv_spi_read_burst(U8 page, U8 reg, U8 *buf, int size);
	void mtv_spi_write(U8 page, U8 reg, U8 val);

	#define	RTV_REG_GET(reg)			(U8)mtv_spi_read(g_bRtvPage, (U8)(reg))
	#define	RTV_REG_BURST_GET(reg, buf, size)	mtv_spi_read_burst(g_bRtvPage, (U8)(reg), buf, (size))
	#define	RTV_REG_SET(reg, val)			mtv_spi_write(g_bRtvPage, (U8)(reg), (U8)(val))
	#define	RTV_REG_MASK_SET(reg, mask, val)\
		do {					\
			U8 tmp;				\
			tmp = (RTV_REG_GET(reg)|(U8)(mask)) & (U8)((~(mask))|(val));\
