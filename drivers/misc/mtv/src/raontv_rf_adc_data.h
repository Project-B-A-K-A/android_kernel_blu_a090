...
#else
#if defined(RTV_ISDBT_6MHZ_BW_ENABLE)
static const struct RTV_ADC_CFG_INFO g_atOfdmCfgTbl_ISDBT[] = {
	 /* TNCO        PNCO1        PNCO2    CFREQ_GAIN  GAIN	  */
...
#elif defined(RTV_ISDBT_7MHZ_BW_ENABLE)
static const struct RTV_ADC_CFG_INFO g_atOfdmCfgTbl_ISDBT[] = {
	 /* TNCO        PNCO1        PNCO2    CFREQ_GAIN  GAIN	  */
	 {0x12F684C0, 0xF50E5600, 0xF0000000, 0x25ED09, 0x4B}, /* 8MHz */
	 {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFF, 0xFF}, /* 8.192MHz.  Unsupport Clock */
	 {0x10DB20AA, 0xF645A1C8, 0xF1C71C72, 0x21B641, 0x43}, /* 9MHz */
	 {0x0FCD6E95, 0xF6E147B1, 0xF2AAAAB4, 0x1F9ADD, 0x3F}, /* 9.6MHz */
};
#else //8MHz BW
static const struct RTV_ADC_CFG_INFO g_atOfdmCfgTbl_ISDBT[] = {
	 /* TNCO        PNCO1        PNCO2    CFREQ_GAIN  GAIN	  */
	 {0x15AC0560, 0xF50E5600, 0xF0000000, 0x2B580A, 0x56}, /* 8MHz */
	 {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFF, 0xFF}, /* 8.192MHz.  Unsupport Clock */
	 {0x13439300, 0xF645A1C8, 0xF1C71C72, 0x268726, 0x4D}, /* 9MHz */
	 {0x120F59C3, 0xF6E147B1, 0xF2AAAAB4, 0x241EB3, 0x48}, /* 9.6MHz */
};
#endif
...
static const struct RTV_ADC_CFG_INFO g_atOfdmCfgTbl_ISDBT[] = {
	/* TNCO 	   PNCO1	  PNCO2	 CFREQ_GAIN  GAIN	 */
	 {0x12F684C0, 0xF23D70A0, 0x00, 0x25ED09, 0x4B}, //8MHz
	 {0xFFFFFFFF, 0xFFFFFFFF, 0xFF, 0xFFFFFF, 0xFF}, // 8.192MHz /* Unsupport Clock */
	 {0x10DB20AA, 0xF3C4D5E4, 0x00, 0x21B641, 0x43}, //9MHz
	 {0xFFFFFFFF, 0xFFFFFFFF, 0xFF, 0xFFFFFF, 0xFF}, //9.6MHz /* Unsupport Clock */
};
#else //8MHz BW
static const struct RTV_ADC_CFG_INFO g_atOfdmCfgTbl_ISDBT[] = {
	/* TNCO 	   PNCO1	  PNCO2	 CFREQ_GAIN  GAIN	 */
	 {0x15AC0560, 0xF23D70A0, 0x00, 0x2B580A, 0x56}, //8MHz
	 {0xFFFFFFFF, 0xFFFFFFFF, 0xFF, 0xFFFFFF, 0xFF}, // 8.192MHz /* Unsupport Clock */
	 {0x13439300, 0xF3C4D5E4, 0x00, 0x268726, 0x4D}, //9MHz
	 {0xFFFFFFFF, 0xFFFFFFFF, 0xFF, 0xFFFFFF, 0xFF}, //9.6MHz /* Unsupport Clock */
};
...
static const struct RTV_ADC_CFG_INFO g_atOfdmCfgTbl_ISDBT[] = {
	/* TNCO 	   PNCO1	  PNCO2	 CFREQ_GAIN  GAIN	 */
	 ...
	 {0xFFFFFFFF, 0xFFFFFFFF, 0xFF, 0xFFFFFF, 0xFF},   // Based 32MHz, 8.192MHz  /* Unsupport Clock */
	 {0x10DB20AA, 0xF3C4D5E4, 0x00, 0x21B641, 0x43}, //9MHz
	 {0x0FCD6E95, 0xF488888D, 0x00, 0x1F9ADD, 0x3F}, //9.6MHz
};
#else //8MHz BW
static const struct RTV_ADC_CFG_INFO g_atOfdmCfgTbl_ISDBT[] = {
	/* TNCO 	   PNCO1	  PNCO2	 CFREQ_GAIN  GAIN	 */
	 ...
	 {0xFFFFFFFF, 0xFFFFFFFF, 0xFF, 0xFFFFFF, 0xFF},   // Based 32MHz, 8.192MHz  /* Unsupport Clock */
	 {0x13439300, 0xF3C4D5E4, 0x00, 0x268726, 0x4D}, //9MHz
	 {0x120F59C3, 0xF488888D, 0x00, 0x241EB3, 0x48}, //9.6MHz
};
#endif
static const E_RTV_ADC_CLK_FREQ_TYPE g_aeAdcClkTypeTbl_ISDBT[] = {
	RTV_ADC_CLK_FREQ_8_MHz,
