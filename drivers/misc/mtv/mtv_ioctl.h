...
#define IOCTL_ISDBT_SUSPEND		_IO(RAONTV_IOC_MAGIC, 19)
#define IOCTL_ISDBT_RESUME		_IO(RAONTV_IOC_MAGIC, 20)
...
#define IOCTL_TDMB_POWER_ON			_IOR(RAONTV_IOC_MAGIC, 30, int)
#define IOCTL_TDMB_POWER_OFF		_IO(RAONTV_IOC_MAGIC, 31)
#define IOCTL_TDMB_SCAN_FREQ		_IOWR(RAONTV_IOC_MAGIC,32, IOCTL_TDMB_SCAN_INFO)
#define IOCTL_TDMB_OPEN_FIC			_IOR(RAONTV_IOC_MAGIC, 33, int)
#define IOCTL_TDMB_CLOSE_FIC		_IO(RAONTV_IOC_MAGIC, 34)
#define IOCTL_TDMB_READ_FIC			_IOR(RAONTV_IOC_MAGIC,35, IOCTL_TDMB_READ_FIC_INFO)
#define IOCTL_TDMB_OPEN_SUBCHANNEL		_IOWR(RAONTV_IOC_MAGIC,36, IOCTL_TDMB_SUB_CH_INFO)
#define IOCTL_TDMB_CLOSE_SUBCHANNEL		_IOW(RAONTV_IOC_MAGIC,37, unsigned int)
#define IOCTL_TDMB_CLOSE_ALL_SUBCHANNELS	_IO(RAONTV_IOC_MAGIC,38)
#define IOCTL_TDMB_GET_LOCK_STATUS		_IOR(RAONTV_IOC_MAGIC,39, unsigned int)
#define IOCTL_TDMB_GET_SIGNAL_INFO		_IOR(RAONTV_IOC_MAGIC,40, IOCTL_TDMB_SIGNAL_INFO)
#endif
...
#define IOCTL_FM_POWER_ON		_IOWR(RAONTV_IOC_MAGIC,50, IOCTL_FM_POWER_ON_INFO)
#define IOCTL_FM_POWER_OFF		_IO(RAONTV_IOC_MAGIC, 51)
#define IOCTL_FM_SET_FREQ		_IOWR(RAONTV_IOC_MAGIC,52, IOCTL_FM_SET_FREQ_INFO)
#define IOCTL_FM_SCAN_FREQ		_IOWR(RAONTV_IOC_MAGIC,53, IOCTL_FM_SCAN_INFO)
#define IOCTL_FM_SRCH_FREQ		_IOWR(RAONTV_IOC_MAGIC,54, IOCTL_FM_SRCH_INFO)
...
#define IOCTL_DAB_POWER_ON			_IOR(RAONTV_IOC_MAGIC, 70, int)
#define IOCTL_DAB_POWER_OFF			_IO(RAONTV_IOC_MAGIC, 71)
#define IOCTL_DAB_SCAN_FREQ			_IOWR(RAONTV_IOC_MAGIC,72, IOCTL_DAB_SCAN_INFO)
#define IOCTL_DAB_GET_FIC_SIZE		_IOR(RAONTV_IOC_MAGIC, 73, unsigned int)
#define IOCTL_DAB_OPEN_FIC			_IOR(RAONTV_IOC_MAGIC, 74, int)
#define IOCTL_DAB_CLOSE_FIC			_IO(RAONTV_IOC_MAGIC, 75)
#define IOCTL_DAB_READ_FIC			_IOWR(RAONTV_IOC_MAGIC,76, IOCTL_DAB_READ_FIC_INFO)
#define IOCTL_DAB_OPEN_SUBCHANNEL		_IOWR(RAONTV_IOC_MAGIC,77, IOCTL_DAB_SUB_CH_INFO)
#define IOCTL_DAB_CLOSE_SUBCHANNEL		_IOW(RAONTV_IOC_MAGIC,78, unsigned int)
#define IOCTL_DAB_CLOSE_ALL_SUBCHANNELS	_IO(RAONTV_IOC_MAGIC,79)
#define IOCTL_DAB_GET_LOCK_STATUS		_IOR(RAONTV_IOC_MAGIC,80, unsigned int)
#define IOCTL_DAB_GET_SIGNAL_INFO		_IOR(RAONTV_IOC_MAGIC,81, IOCTL_DAB_SIGNAL_INFO)
