 ...
 * By default, this compile option is disabled.
 */
#if  defined(ZCFG_MK_MSG22XX_UPDATE_FIRMWARE)
 ...
 * By default, this compile option is disabled.
 */
#if  defined(ZCFG_MK_MSG22XX_ENABLE_ESD)
 ...
 */
#include <soc/sprd/board.h>
#if defined(ZCFG_LCM_WIDTH)
#define TOUCH_SCREEN_X_MAX	 (ZCFG_LCM_WIDTH) 
#else
#define TOUCH_SCREEN_X_MAX	 (480) //LCD_WIDTH
#endif
#if defined(ZCFG_LCM_HEIGHT)
#define TOUCH_SCREEN_Y_MAX	 (ZCFG_LCM_HEIGHT) 
#else
...
/*--------------------------------------------------------------------------*/
struct msg2xxx_ts_platform_data{
	int irq_gpio_number;
