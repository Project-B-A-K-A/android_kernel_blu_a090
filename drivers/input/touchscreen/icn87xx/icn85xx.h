...
//#define CTP_RST_PORT             0//RK30_PIN1_PB1
...
#if defined(ZCFG_ICN87XX_SUPPORT_CHECK_ESD)
	 #define SUPPORT_CHECK_ESD           	1  //To check the ESD mode
#else
	#define SUPPORT_CHECK_ESD			   0  //To check the ESD mode
#endif
     #define ICN85XX_NAME                "icn85xx_ts"//"chipone-ts"
     
     #define ICN85XX_NORMAL_IIC_ADDR     0x48// (0x80>>1)//(0x90>>1)
     #define ICN85XX_PROG_IIC_ADDR       0x30
     #define ICN87XX_PROG_IIC_ADDR       0x30   //add by carlos_hu
...
struct icn85xx_ts_platform_data{
	int irq_gpio_number;
