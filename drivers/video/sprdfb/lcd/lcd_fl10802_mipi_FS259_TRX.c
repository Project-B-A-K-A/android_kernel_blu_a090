...
static LCM_Init_Code init_data[] ={ 
	...
	{LCM_SEND(7), {5,0,0xB1,0x22,0x1A,0x1A,0x87}},	 
		 
	{LCM_SEND(2), {0xB2,0x22}},  //480x854 
	
	{LCM_SEND(11), {9,0,0xB3,0x01,0x00,0x06,0x06,0x16,0x12,0x37,0x34}},  //HFP_GEN 
	
	{LCM_SEND(20), {18,0,0xBA,0x31,0x00,0x44,0x25,0xB1,0x0A,0x00,0x00,0xC1,0x00,0x00,0x00,0x0D,0x02,0x5D,0xB5,0xEE}},  //17 
	
	{LCM_SEND(8), {6,0,0xE3,0x05,0x05,0x01,0x01,0x00}},  // 
	
	{LCM_SEND(2), {0xB4,0x02}},  //00:column inversion, 02:2-dot inversion	
	
	{LCM_SEND(2), {0xC7,0xC0}},  //
	
	{LCM_SEND(5), {3,0,0xB5,0x02,0x02}},  //   
	
	{LCM_SEND(5), {3,0,0xB6,0x19,0x19}},  //VCOM OFFSET 19
	
	{LCM_SEND(5), {3,0,0xB8,0x64,0x22}},  //2x, 2.5x   
	
	{LCM_SEND(2), {0xCC,0x02}},  //   
	
	{LCM_SEND(2), {0xBC,0x47}},  //   
	
	{LCM_SEND(54), {52,0,0xE9,0x00,0x00,0x0F,0x03,0x69,0x0A,0x8A,0x12,0x31,0x23,0x37,0x11,0x0A,0x8A,0x37,0x00,0x06,0x18,0x00,0x00,	 
						   0x00,0x10,0x88,0x83,0x11,0x35,0x75,0x78,0x88,0x88,0x88,0x88,0x82,0x00,0x24,0x64,0x68,0x88,0x88,0x88,0x00,
						   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},  //53//CKS	 
	
	
	{LCM_SEND(25), {23, 0,0xEA,0x90,0x00,0x00,0x00,0x88,0x84,0x60,0x64,0x22,0x08,0x88,0x88,0x88,0x88,0x85,0x71,0x75,0x33,0x18,0x88,0x88,0x88}},  //COSR17,COS18 
	
	{LCM_SEND(37), {35,0,0xE0,0x00,0x04,0x09,0x22,0x2E,0x3F,0x1A,0x36,0x08,0x0F,0x0F,0x11,0x12,0x10,0x13,0x15,0x1A,0x00,0x04,
					0x09,0x22,0x2E,0x3F,0x1A,0x36,0x08,0x0F,0x0F,0x11,0x12,0x10,0x13,0x15,0x1A}},	//34
