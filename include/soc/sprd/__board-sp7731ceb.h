...
#define GPIO_TOUCH_RESET         71
#define GPIO_TOUCH_IRQ           72
...
#define ZCFG_LCM_HEIGHT 854
/*----Add zyt.h - Please #include <soc/sprd/board.h> ----*/
/*TP ÐéÄâ¼üÎ»ÖÃ*/
#define ZCFG_TP_FOCALTECH_KEY_MAP  {60,900,60,40,180,900,60,40,300,900,60,40}
#define ZCFG_DISABLE_CHG_FGU_SOC_ADJUST
#define ZCFG_BACKLIGHT_WHTLED_LEVEL 63   ////180mA